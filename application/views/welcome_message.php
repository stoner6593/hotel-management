    ...
    <div class="container">
      <div class="row">
        <div class="span6">
          <div class="widget widget-nopad" id="target-1">
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                <div class="widget-content">
                  <h6 class="bigstats"> ¿Qué pasó hoy en el Hotel? </h6>
                  <div id="big_stats" class="cf">
                    <!-- <div class="stat"> <i class="icon-anchor"></i> <span class="value"><?=@$today_stats["reservation"]?></span> <br>Room Service </div> -->
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-list-alt"></i> <span class="value"><?=@$today_stats["reservation"]?></span> <br>Reservaciones</div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-user"></i> <span class="value"><?=@$today_stats["customer"]?></span> <br>Clientes </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-user-md"></i> <span class="value"><?=@$today_stats["medicalservice"]?></span> <br>Servicio Médico </div>
                    <!-- .stat --> 
                  <!-- </div>
                  <div id="big_stats" class="cf">
                    ...
                    <div class="stat"> <i class="icon-retweet"></i> <span class="value"><?=@$today_stats["massage"]?></span> <br>Sala Masajes </div>
                    <!-- .stat --> 
                  </div>
                </div>
                <!-- /widget-content --> 
          ...
          <!-- /widget -->
          <div class="widget widget-nopad" style="display: none;">
            <div class="widget-header"> <i class="icon-list-alt"></i>
              <h3> Calendario</h3>
            </div>
            <!-- /widget-header -->
        ...
        <div class="span6">
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="shortcuts">
                <a href="/room" class="shortcut"><i class="shortcut-icon icon-home"></i><span class="shortcut-label">Habitaciones</span> </a>
                <a href="/reservation/list_report" class="shortcut"><i class="shortcut-icon icon-list-alt"></i><span class="shortcut-label">Reservaciones</span> </a>
                <a href="/login/logout" class="shortcut"><i class="shortcut-icon icon-off"></i><span class="shortcut-label">Salir</span> </a>
          ...
          <div class="widget" id="target-2">
            <div class="widget-header"> <i class="icon-group"></i>
              <h3> Clientes de la próxima semana del hotel</h3>
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
